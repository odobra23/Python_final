...
$(document).ready(function(){
    ...
    myDate= unescape(temp[1]);
    var temp1 = parameters[1].split("=");
    myDate1 = unescape(temp1[1]);
    var temp2 = parameters[2].split("=");
    myDate2 = unescape(temp2[1]);
    myValue = myDate + "-" + myDate1 + "-" + myDate2;
    document.getElementById("date").setAttribute('value',myValue)
